    ...
    return (
        <>
            <React.Fragment>
                ...
                {
                    currentRole === "Easycart" &&
                    <ListItemButton
                        component={Link} to="/Seller/Easycart"
                        sx={location.pathname.startsWith('/Seller/Easycart') ? styles.currentStyle : styles.normalStyle}
                    >
                        <ListItemIcon>
                            <AdminPanelSettingsIcon sx={{ color: location.pathname.startsWith("/Seller/Easycart") ? '#4d1c9c' : 'inherit' }} />
                        </ListItemIcon>
                        <ListItemText primary="Easycart" />
                    </ListItemButton>
                }
            </React.Fragment>
            <Divider sx={{ my: 1 }} />
